...
import { AD_TAG, PLAYER_CONFIG } from './src/playerConfig';
  ...
  return (
    <SafeAreaRoot style={styles.screen}>
      ...
      <View style={styles.header}>
        <Text style={styles.eyebrow}>PLAYER / ADS (IMA)</Text>
        <Text style={styles.title}>Brightcove Player</Text>
        <Text style={styles.description}>
          Client-side ad insertion with Google IMA. A single VMAP ad-tag URL
          drives the pre/mid/post ad schedule.
        </Text>
      </View>
      ...
      <BrightcovePlayerView
        ...
        onAllAdsCompleted={() => {
          setStatus({ kind: 'ready', message: 'All ads completed' });
        }}
        onAdError={({ nativeEvent }) => {
          // An ad failure does not fail content playback; surface it but keep
          // playing the video.
          setStatus({
            kind: 'ad',
